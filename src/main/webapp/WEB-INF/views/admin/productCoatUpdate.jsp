			...
			<div style="padding-top:20px;">
				<form action="/admin/productCoatUpdate" name="productCoatUpdate" id="productCoatUpdate" method="post">
					...
					<div class="form-group coatId">
						<label>상의 ID</label>
						<input type="text" name="coatId" value='<c:out value="${productInfo.coatId}" />'  class=" id_input form-control" readonly="readonly" >
					</div>
...
<script>	
	...
	$("#CoatDeleteBtn").on("click",function(e){
		...
		actionForm.append('<input type="hidden" name="coatId" value="${productInfo.coatId}">');
