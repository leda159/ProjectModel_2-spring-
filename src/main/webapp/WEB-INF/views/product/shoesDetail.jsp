...
.content_bottom{
	...
	<div class="content_top">
		<div class="ct_left_area">
			<div class="image_wrap" data-shoesNumber ="${productShoesInfo.imageList[0].shoesNumber}" data-path="${productShoesInfo.imageList[0].uploadPath}" data-uuid="${productShoesInfo.imageList[0].uuid}" data-filename="${productShoesInfo.imageList[0].fileName}">
				<img>
			</div>				
		</div>
		<div class="ct_right_area">
			<div class="title">
				<h1>
					${productShoesInfo.shoesName}
				</h1>
			</div>
			<div class="line"></div>	
			<div class="price">
				<div class="sale_price">정가 : <fmt:formatNumber value="${productShoesInfo.shoesPrice}" pattern="#,### 원" />
				</div>
...
$(document).ready(function(){
	...
	$(".image_wrap").each(function(i, obj){
		...
		if(sobj.data("uuid")){
			...
			sobj.find("img").attr('src', '/display?fileName=' + fileCallPath);
		} else {
...
const form = {
		...
		shoesNumber :'${productShoesInfo.shoesNumber}',
		shoesCount :	''
...
$(".btn_cart").on("click",function(e){
	form.shoesCount = $(".quantity_input").val();
	$.ajax({
		url: '/cart/ShoesAdd',
		type: 'POST',
		data: form,
