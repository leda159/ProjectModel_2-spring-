...
<c:if test="${pantsListCheck != 'empty'}">
	<div class="list_search_result">
		<table class="type_list">
			...
			<tbody id="searchList>">
				<c:forEach items="${pantsList}" var="pantsList">
					<tr>
						<td class="image">
							<div class="image_wrap" data-pantsNumber ="${pantsList.imageList[0].pantsNumber}" data-path="${pantsList.imageList[0].uploadPath}" data-uuid="${pantsList.imageList[0].uuid}" data-filename="${pantsList.imageList[0].fileName}">
								<img>
							</div>						
						</td>
						<td class="detail">
						...
						<td class="price">
							<div class="org_price">
								<del>
									<fmt:formatNumber value="${pantsList.pantsPrice}" pattern="#,### 원" />
								</del>
							</div>
							<div class="sell_price">
								<strong>
									<fmt:formatNumber value="${pantsList.pantsPrice * (1-pantsList.pantsDiscount)}" pattern="#,### 원" />
								</strong>
							</div>
						</td>
					</tr>
...
<form id="actionForm" action="/product/pants" method="get">
...
$(".move").on("click",function(e){
	...
	actionForm.attr("action","/product/pantsDetail");
	actionForm.submit();
